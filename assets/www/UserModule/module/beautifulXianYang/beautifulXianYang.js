...
;define(function(require, exports, module){
    ...
    var photoSwipe = function(o){
        ...
        var items = [];
        aigovApp.utils.openLoading();// 打开加载圈
        $("<img/>").attr("src", $this.attr("maxSrc")).load(function() {
            aigovApp.utils.closeLoading();// 关闭加载圈
    ...
    var load = function(winObj){
        var url = aigovApp.constants.hotLine.BEAUTIFUL_XIANYANG_LIST;
...
//		});
        ...
        documentList._loadHtml(componentPath + 'template/beautifulXianYangList.html',function(tplHtml){
    ...
    var openFrom = function($record){
        ...
        if(type=='like'){
            ...
            aigovApp.openAppWindow('beautifulXianYangReply',params);
        }else if(type=='del'){
    ...
    module.exports = {
        ...
        onCreate : function(winObj){
            ...
            var btnHtml = '<a href="javascript:void(0);" id="factBtn" onclick="aigovApp.openAppWindow(\'uploadPic\');">我要上传</a>'
