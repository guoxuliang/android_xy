...
//			var url = PROJECT_URL+"hotMail/getHotMailList";
            var url = "http://ydt.xy12345.cn/edot//hotMail/getHotMailList?model_id=12";
		    ...
		    var documentList = winObj.getComponent('12345mailList');// html中定义
		   // this.intent=winObj.intent;
		    ...
		    documentList._loadHtml(componentPath + 'template/12345mailList.html',function(tplHtml){
		...
		openFrom:function($record){
			var id = $record.data('id');
			 aigovApp.openAppWindow('myRelateDetail',{"id":id, "modelId":"12"});
		},
